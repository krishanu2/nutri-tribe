...
export default async function TermsPage() {
  const policy = await db.policy.findUnique({ where: { type: 'TERMS' } }).catch(() => null);
    ...
    <div className="min-h-screen bg-ivory-grain pt-28 pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="mb-10">
          ...
          <h1 className="font-display font-bold text-4xl text-earthen-rust mb-2">{policy?.title ?? 'Terms & Conditions'}</h1>
          {policy && (
