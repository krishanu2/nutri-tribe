...
export const metadata: Metadata = {
  ...
  description:
    "Discover the heritage, harvest and nutrition behind NutriTribe's premium 6 Suta Makhana — gluten-free fox nuts hand-picked from the lily ponds of Mithila, Bihar by the Mallah community.",
  openGraph: {
